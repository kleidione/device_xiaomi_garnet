...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_global-user 14 UKQ1.231003.003 V816.0.12.0.UNRMIXM release-keys";
            fingerprint = "Redmi/garnet_global/garnet:14/UKQ1.231003.002/V816.0.12.0.UNRMIXM:user/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50G";
        } else {
            brand = "POCO";
            description = "garnetp_global-user 14 UKQ1.231003.003 V816.0.12.0.UNRMIXM release-keys";
